...
const ContactForm = () => {
        ...
        return (
            <div className="bg-gray-50 text-gray-800 py-16 md:px-12 lg:px-24 ">
                <Loader loading={loading} success={success} failure={fail}/>
                ...
                <div className="max-w-6xl mx-auto px-5 bg-white rounded-xl shadow-lg overflow-hidden mt-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0 min-h-[600px]">
                        <div
                            className="bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-secondary)] p-5 sm:p-10 text-white flex flex-col justify-between relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="mt-6 opacity-90 leading-relaxed">
                                    We're happy to answer any questions you may have and help you determine which of our
                            ...
                            <div className="mt-8 space-y-4 relative z-10">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0 bg-white bg-opacity-20 p-2 rounded-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-950" fill="none"
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="font-semibold lg:text-lg sm:text-sm">info@softdetroits.com</p>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className="hover:cursor-pointer w-full bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-secondary)] text-white font-semibold py-3 px-4 rounded-lg hover:opacity-90 transition-all shadow-md hover:shadow-lg"
                                    >
                                        Send Your Message
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline ml-2" fill="none"
                                             viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
