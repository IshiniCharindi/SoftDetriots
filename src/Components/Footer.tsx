...
const Footer = () => {
    ...
    return (
        <div className="py-10 bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-secondary)] sm:pt-16 lg:pt-24">
                    ...
                    {sections.map((section, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium text-white md:underline">{section.title}</h3>
                                {isMobile && (
                                    <svg
